...
namespace School_DB_System
{
    public partial class Bus : SSSTPageParent
    {
        ...
        protected override void initializeDataGridView()
        {
            ...
            RequestList.Columns.Add().ColumnName = "BusNumber";//adding the first column with header text = "ID"
        ...
        {
            DataTable routes = controllerObj.getRoutes();
        ...
        protected override void Filter_Btn_Click(object sender, EventArgs e)
        {
            ...
            {
                busesList = getAllBuses(); //sends a query to retrieve all students (ID, Name, Email, Year)
            ...
            {
                busesList = controllerObj.getBusesOfRoute(///);
                Data_Dt.DataSource = busesList; //linking student datagridview with students list datatable
        ...
        private DataTable getAllBuses()
        {
            DataTable tempbusesList = controllerObj.getAllBuses(); //sends a query to retrieve all students (ID, Name, Email, Year)
            ...
            busesList.Columns.Add("std_Year", typeof(string)); //creating a column of name 'std_year' and of type string
        ...
        protected override void Delete_Btn_Click(object sender, EventArgs e)
        {
            ...
            if (result == DialogResult.Yes) //if confirmed "Yes"
            {
                ...
                {
                    string BusNum = row.Cells[1].Value.ToString();//gets student ID from selected row
        ...
        protected override void Update_Btn_Click(object sender, EventArgs e)
        {
            ...
            else
            {
                ...
                string BusNum = Convert.ToString(selectedRow.Cells["ID"].Value);//getting data from the selected row (ID) column because its the needed cell value to ened queries
