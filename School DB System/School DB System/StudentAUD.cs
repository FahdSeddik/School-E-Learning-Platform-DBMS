...
using static System.ComponentModel.Design.ObjectSelectorEditor;
    ...
    namespace School_DB_System
    {
        ...
        public partial class StudentAUD : BaseAUD //inherits from usercontrol
        {
            //DATA MEMBERS
            ViewController viewController; //viewcontroller object
            Controller controllerObj; // controller object
            //non default constructor
            public StudentAUD(ViewController viewController, Controller controllerObj) : base(viewController, controllerObj)
            {
