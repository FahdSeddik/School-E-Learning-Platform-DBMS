...
namespace School_DB_System
{
    ...
    public partial class AUVTeacherBase : AUVStaffBase //inherits from usercontrol
    {
        ...
        public AUVTeacherBase(ViewController viewController, Controller controllerObj) : base(viewController, controllerObj)
        {
